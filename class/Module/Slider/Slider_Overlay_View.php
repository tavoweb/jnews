	        ...
	        if( $attr['overlay_option'] === 'gradient' && $attr['gradient_overlay_enable'])
	        {
		        $style .=
			        ".{$this->unique_id} .jeg_overlay_slider_wrapper:before {
                            background: -moz-linear-gradient({$attr['gradient_overlay_degree']}deg, {$attr['gradient_overlay_start_color']} 0%, {$attr['gradient_overlay_end_color']} 100%);
                            background: -webkit-linear-gradient({$attr['gradient_overlay_degree']}deg, {$attr['gradient_overlay_start_color']} 0%, {$attr['gradient_overlay_end_color']} 100%);
                            background: linear-gradient({$attr['gradient_overlay_degree']}deg, {$attr['gradient_overlay_start_color']} 0%, {$attr['gradient_overlay_end_color']} 100%);
                        }";
	        }
