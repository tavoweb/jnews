...
Class Element_Ads_Option extends ModuleOptionAbstract
{
    ...
    public function get_ads_option()
    {
        ...
        $this->options[] = array(
            ...
            'heading'       => esc_html__('[Image Ads] Ads Image Desktop', 'jnews'),
	    ...
	    $this->options[] = array(
		    ...
		    'heading'       => esc_html__('[Image Ads] Ads Image Tablet', 'jnews'),
	    ...
	    $this->options[] = array(
		    ...
		    'heading'       => esc_html__('[Image Ads] Ads Image Phone', 'jnews'),
