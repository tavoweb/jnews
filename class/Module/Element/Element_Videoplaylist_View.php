...
Class Element_Videoplaylist_View extends ModuleViewAbstract
{
    ...
    public function render_module($attr, $column_class)
    {
        ...
        $output =
            "<div {$this->element_id($attr)} class=\"jeg_video_playlist jeg_col_{$col_width_raw} {$layout} {$schema} {$this->unique_id} {$this->get_vc_class_name()} {$attr['el_class']}\" data-unique='{$this->unique_id}'>
