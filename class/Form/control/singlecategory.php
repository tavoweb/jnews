<div class="widget-wrapper type-singlecategory" data-field="<?php echo esc_attr($fieldkey) ?>" <?php echo !empty( $dependency ) ? 'data-dependency="' . esc_attr( json_encode( $dependency ) ) . '"' : ''; ?>>
    ...
    <div class="singlecategory-wrapper <?php esc_attr_e($ajax_class); ?>">
