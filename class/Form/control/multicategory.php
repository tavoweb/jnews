<div class="widget-wrapper type-multicategory" data-field="<?php echo esc_attr($fieldkey) ?>" <?php echo !empty( $dependency ) ? 'data-dependency="' . esc_attr( json_encode( $dependency ) ) . '"' : ''; ?>>
    ...
    <div class="multicategory-wrapper <?php esc_attr_e($ajax_class); ?>">
