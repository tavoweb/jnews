...
Class SinglePost
{
	...
	public function post_date_format($post)
	{
		...
		{
			return jeg_get_post_date(null, $post);
		}
		else if ( $date_format )
		{
	...
	{
		if ( $this->get_template() === 'custom' ) return false;
    ...
    public function feature_post_1($image_size = null, $gallery_size = null)
    {
        ...
        switch($format) {
            case 'gallery' :
                if($gallery_size === null) $gallery_size = $this->get_gallery_thumbnail_size();
            ...
            case 'video' :
                ...
                break;
            default :
                if($image_size === null) $image_size = $this->get_single_thumbnail_size();
