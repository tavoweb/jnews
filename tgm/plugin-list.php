...
function jnews_plugin_group()
{
    $groups = array(
        ...
        'gutenberg' => array(
	        ...
	        'notice' => esc_html__('Please install both of plugin to enable Gutenberg editor on your website', 'jnews'),
	        'items' => array(
		        array(
...
add_action( 'admin_bar_menu', 'jnews_plugin_update_notice', 99);
