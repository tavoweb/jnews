(function($){
    $('document').ready(function()
    {
        ...
        window.widget_script = function(wrapper)
        {
            ...
            $(container).find('.singlecategory-wrapper').each(function(){
                var element = $(this),
                    options = JSON.parse(element.find('.data-option').text());
            ...
            $(container).find('.multicategory-wrapper').each(function(){
                var element = $(this),
                    options = JSON.parse(element.find('.data-option').text());
            ...
            $(container).find('.multitag-wrapper').each(function(){
                var element = $(this),
                    options = JSON.parse(element.find('.data-option').text());
            ...
            $(container).find('.multiauthor-wrapper').each(function(){
                var element = $(this),
                    options = JSON.parse(element.find('.data-option').text());

                if (element.hasClass('jeg-ajax-load'))
                {
                    selectize_control(element, options, true, 'vp_find_ajax_author', true);
                } else {
                    selectize_control(element, options, false, false, true);
                }
            });
