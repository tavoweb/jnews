(function($){
    ...
    if ( hasSelectiveRefresh ) {
        ...
        wp.customize.selectiveRefresh.bind( 'partial-content-rendered', function( placement ) {
            ...
            if(contain_string(refresh_id, ['jnews_header_menu_animation'])) {
                jnews.menu.init($(placement.container));
            }

            if(contain_string(refresh_id, ['jnews_single_following_video', 'jnews_single_following_video_position'])) {
                $.do_media_render($(placement.container));
                window.jnews.floating_video.unbind();
                window.jnews.floating_video.init($(placement.container));
            }
