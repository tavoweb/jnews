...
<div class='vp-multitermhierarchy-wrapper'>
    ...
    ?>
	<input type="text" name="<?php echo esc_attr($name); ?>" class="vp-input input-large input-sortable widefat code multitermhierarchy <?php echo esc_attr( $ajax_class ); ?>" value="<?php echo esc_attr($value); ?>" />
