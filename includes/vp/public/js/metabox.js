...
(function ($) {
                        ...
                        load: function(query, callback)
                        {
                            if ( ajax_load )
                            {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        'string' : query,
                                        'action'  : 'vp_find_ajax_post_category'
                                    },
                                    error: function() {
                                        callback();
                                    },
    ...
    function do_singletermhierarchy() {

        var $multiselect = $('.vp-singletermhierarchy-wrapper input.input-sortable');
