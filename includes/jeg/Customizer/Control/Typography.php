	...
	protected function content_template() {
		...
		<div class="wrapper">
			...
			<# if ( false !== data.default['font-size'] ) { #>
				<div class="font-size">
					<h5>Font Size</h5>
					<input type="text" value="{{ data.value['font-size'] }}" placeholder="<?php echo esc_attr__('Ex: 12px', 'jnews'); ?>"/>
				</div>
			<# } #>
			...
			<# if ( false !== data.default['line-height'] ) { #>
				<div class="line-height">
					<h5>Line Height</h5>
					<input type="text" value="{{ data.value['line-height'] }}" placeholder="<?php echo esc_attr__('Ex: 30px', 'jnews'); ?>"/>
				</div>
			<# } #>
